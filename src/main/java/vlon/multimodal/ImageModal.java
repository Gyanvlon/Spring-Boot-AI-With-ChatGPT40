...
public class ImageModal {
    ...
    public String describeImage() throws IOException {
        byte[] imageData = new ClassPathResource("/images/cat-dog.jpg").getContentAsByteArray();
    ...
    public String code() throws IOException {
        byte[] imageData = new ClassPathResource("/images/test-case.png").getContentAsByteArray();
